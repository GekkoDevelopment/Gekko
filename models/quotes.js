export default {
  ...
  philosophyQuotes: {
    quotes: [
      ...
      {
        quote:
          "There are two main human sins from which all the other derive: impatience and indolence.",
        author: "Franz Kafka",
      },
      {
        quote: "Remember to keep a clear head in difficult times.",
      ...
      {
        quote:
          "To doubt everything or to believe everything are two equally convenient solutions; both dispense with necessity of reflection.",
