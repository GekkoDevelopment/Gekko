...
module.exports = {
    ...
    async execute(role) {
        const logChannelId = await MySQL.getValueFromTableWithCondition('guilds', 'logging_channel', 'guild_id', role.guild.id);
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor('Green')
            .setTimestamp()
            .setFooter({ text: 'Gekkō', iconURL: role.client.user.displayAvatarURL() });
