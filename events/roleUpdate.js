...
module.exports = {
    ...
    async execute(oldRole, newRole) {
        const logChannelId = await MySQL.getValueFromTableWithCondition('guilds', 'logging_channel', 'guild_id', newRole.guild.id);
        ...
        if (oldRole.name !== newRole.name) {
            ...
            .setColor('Orange')
            .setTimestamp()
            .setFooter({ text: 'Gekkō', iconURL: newRole.client.user.displayAvatarURL() });
