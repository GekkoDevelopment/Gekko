const { ButtonBuilder, ButtonStyle, ActionRowBuilder, ChannelType, PermissionsBitField } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = embeds.get('memberCreatedTicket') (interaction, {topic, issue});
        ...
        const successEmbed = embeds.get('memberSuccessTicket') (interaction, {channel})
