...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await MySQL.bulkInsertOrUpdate('tickets', ['guild_id', 'ticket_channel_id', 'ticket_category', 'support_role_id'], [[guildId, ticketChannel.id, ticketCategory.id, supportRole.id]]);
