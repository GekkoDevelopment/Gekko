...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const savedimageUrl = await MySQL.getColumnValuesWithGuildId(
        guildId,
        "image_url"
      );
      ...
      if (savedimageUrl && savedimageUrl !== "null") {
        ...
        await interaction.reply({
          content: `${emojis.passed} Welcome image set, this is how it will appear:\n\n**Welcome to the server, <@${interaction.user.id}>!**`,
          files: [
