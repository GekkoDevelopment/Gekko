...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('gekkō').setDescription('Information about Gekkō'),
    async execute(interaction) {
        ...
        .setAuthor({ name: `${interaction.client.user.username} Development`, iconURL: interaction.client.user.displayAvatarURL() })
        .setColor(color.bot)
